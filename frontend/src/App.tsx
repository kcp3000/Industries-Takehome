...
import { DEFAULT_QUERY, getAvailabilityQueryKey } from "./data/availabilityData";
...
function App() {
  ...
  const queryKey = useMemo(() => getAvailabilityQueryKey(query), [query]);
  ...
  const updateQuery = useCallback(<K extends keyof AvailabilityQuery>(
    key: K,
